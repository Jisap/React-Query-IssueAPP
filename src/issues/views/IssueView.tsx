...
export const IssueView = () => {
  ...
  const params = useParams(); // El id viene de los params del url
  const { id='0'} = params;

  const { issueQuery, commentsQuery } = useIssue( +id ); // Data de un único issue según su id y de sus comentarios
